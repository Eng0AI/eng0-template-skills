---
name: setup
description: Set up the Presentation On Your Data template in the current directory. Use when initializing a new project from this template.
---

# Setup Natural Language Postgres Presentation Template

This skill sets up a presentation-focused Natural Language to SQL app with PPT-style visualizations for showcasing data insights.
