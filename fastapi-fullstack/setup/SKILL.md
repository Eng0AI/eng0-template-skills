---
name: setup
description: Set up the FastAPI Full Stack template in the current directory. Use when initializing a new project from this template.
---

# Setup FastAPI Full Stack Template

This skill sets up a Python full-stack application with FastAPI.
