---
name: setup
description: Set up the Denuvo Reverse Engineering Slides template in the current directory. Use when initializing a new project from this template.
---

# Setup Denuvo Slides Template

This skill sets up a Slidev presentation about reverse engineering Denuvo in Hogwarts Legacy.
